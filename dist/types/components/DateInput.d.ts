...
export interface DateInputProps extends Omit<GovUKDateInputProps, "formGroup" | "hint" | "errorMessage" | "items"> {
    ...
    items?: Array<Omit<GovUkDateInputItem, "value"> & {
        value?: string | number;
        inputmode?: string;
    }>;
}
type GovUkDateInputItem = ValueOfArray<GovUKDateInputProps["items"]>;
export declare function DateInput({ hint, formGroup, errorMessage, ...props }: DateInputProps): Promise<import("hono/utils/html").HtmlEscapedString>;
export {};
