...
export interface FileUploadProps extends Omit<GovUKFileUploadProps, "formGroup" | "label" | "hint" | "errorMessage" | "multipleFilesChosenText"> {
...
export declare function FileUpload({ label, hint, errorMessage, formGroup, multipleFilesChosenText, ...props }: FileUploadProps): Promise<import("hono/utils/html").HtmlEscapedString>;
